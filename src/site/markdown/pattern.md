...
<!-- TOC -->
* [My Learning Path About Design Pattern](#my-learning-path-about-design-pattern)
  * [Structural patterns](#structural-patterns)
  * [Behavioral patterns](#behavioral-patterns)
  * [Messaging Patterns](#messaging-patterns)
  * [Inversion of Control](#inversion-of-control)
  * [The DTO Pattern (Data Transfer Object)](#the-dto-pattern-data-transfer-object)
  * [Event-Driven](#event-driven)
  * [Microservice Architecture](#microservice-architecture)
  * [Techniques](#techniques)
  * [Martinfowler](#martinfowler)
  * [JWT](#jwt)
  * [Articles](#articles)
  * [DEVOXX](#devoxx)
  * [Devnexus](#devnexus)
...
- [Event-Driven Architecture](https://www.baeldung.com/cs/eda-software-design)
...
- [Dev Ops Culture](https://martinfowler.com/bliki/DevOpsCulture.html)
...
- [OAuth2 and OpenID token expiration](https://garnier.wf/blog/2024/06/11/oauth2-token-expiry.html)
...
- [Chopping the monolith - the demo](https://blog.frankel.ch/chopping-monolith-demo/)
...
- [97 Things Every Java Programmer Should Know by TRISHA GEE & KEVLIN HENNEY](https://www.youtube.com/watch?v=td-3t3TBk1I)
- [What’s Looming in Spring? by VENKAT SUBRAMANIAM & JOSH LONG](https://www.youtube.com/watch?v=-t2O1UDwXlM)
- [Know your Java? by Venkat Subramaniam](https://www.youtube.com/watch?v=DHwNR7h3k5Y)
- [Performance oriented Spring Data JPA & Hibernate by Maciej Walkowiak](https://www.youtube.com/watch?v=exqfB1WaqIw)
- [Finding Java’s Hidden Performance Traps by VICTOR RENTEA](https://www.youtube.com/watch?v=hzATjYXplbk)
- [Java’s Hidden Gems: Tools and Libraries by Johan Janssen](https://www.youtube.com/watch?v=ABm0KhsZJ0c)
- [Spring Security: The Good Parts by DANIEL GARNIER-MOIROUX](https://www.youtube.com/watch?v=kwxRe-4dnVU)
- [A design pattern goes to the supermarket by KAYA WEERS](https://www.youtube.com/watch?v=VF0SXojfJso)
- [Datafaker: the most powerful fake data generator library by ELIAS NOGUEIRA](https://www.youtube.com/watch?v=S6Z7vB5zc0g)
...
## Reference
  ...
  2. [sourcemaking.com](https://sourcemaking.com/)
